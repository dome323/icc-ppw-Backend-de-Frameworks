...
public interface ProductService {
     ...
     */
    List<ProductResponseDto> findByUserId(
            Long userId
    );

    List<ProductResponseDto> findByCategoryId(
            Long categoryId
    );

    /*
     * Consulta desde el contexto de usuario.
     */
    ...
    /*
     * Consulta desde el contexto de categoría.
     */
     ...
     */
    Page<ProductResponseDto> findAllPage(
