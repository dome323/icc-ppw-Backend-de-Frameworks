...
/*
 * Servicio encargado de crear, validar,
 * rotar y revocar refresh tokens.
 */
@Service
public class RefreshTokenService {
     ...
     *
     * El token se genera como JWT
     * y también se guarda en base de datos.
     */
    @Transactional
     ...
     *
     * Validaciones:
     * 1. El JWT debe ser válido.
     * 2. Debe ser de tipo refresh.
     * 3. Debe existir en base de datos.
     * 4. No debe estar revocado.
     * 5. No debe estar expirado.
     * 6. El usuario dueño del token debe estar activo.
     */
    @Transactional
    public RefreshTokenEntity validateAndGetActiveToken(
            String token
    ) {
        ...
        if (
            ...
            throw new BadRequestException(
                    "Usuario no válido para este refresh token"
            );
        }
     ...
     *
     * En esta práctica se usa durante login
     * para dejar una sola sesión activa por usuario.
     */
    @Transactional
    public void revokeAllByUser(
            UserEntity user
    ) {
